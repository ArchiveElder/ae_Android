...
Java_com_example_ae_1android_ui_coloring_ColorOnPicFragment_detectEdgeJNI(JNIEnv *env, jobject thiz,
                                                                          jlong input_image,
                                                                          jlong output_image,
                                                                          jint th1, jint th2) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_ae_1android_ui_coloring_ColorOnPicFragment_MeanShiftFilteringJNI(JNIEnv *env,
                                                                                  jobject thiz,
                                                                                  jlong input_image,
                                                                                  jlong output_image,
                                                                                  jdouble sp,
